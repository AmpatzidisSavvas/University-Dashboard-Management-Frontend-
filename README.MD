...
```bash
git clone https://github.com/AmpatzidisSavvas/University-Dashboard-Management-Frontend-.git
...
Replace the placeholder values with your real credentials. You can get these by signing up at: [**Cloudinary**].
**Running the Project**
